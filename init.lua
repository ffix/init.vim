...
-- keymap('n', '<C-p>', [[<cmd>lua require('telescope.builtin').find_files({previewer = false})<CR>]], { noremap = true, silent = true })
...
-- keymap('n', '<C-b>', [[<cmd>lua require('telescope.builtin').oldfiles()<CR>]], { noremap = true, silent = true })
...
-- luasnip.filetype_extend("python", "go")
...
-- vim.g.nvim_tree_ignore = {'.git', 'venv', '__pycache__'}
